...
const relativeImagePath = "/api/github-stats?username=danielp1218&dithering=true&include_all_commits=true&pixelate_avatar=false&theme=fuji&color=%23ffffffFF&hide=issues"
...
const uploadToBlob = async (imageFile: ArrayBuffer) => {
    try {
        ...
        return new Response('Cron job executed: GitHub stats image uploaded to Vercel Blob Storage at ' + url, { status: 200 });
    } catch (error) {
